...
exports.LighterVesselsController = void 0;
...
let LighterVesselsController = class LighterVesselsController {
    masterVessels;
    ...
    async getOne(id) {
        ...
        if (!row) {
            throw new common_1.NotFoundException("Lighter vessel was not found");
        }
        return row;
    }
    create(dto) {
...
exports.LighterVesselsController = LighterVesselsController;
__decorate([
    (0, common_1.Get)(),
...
], LighterVesselsController.prototype, "list", null);
__decorate([
    (0, common_1.Get)(":id"),
...
], LighterVesselsController.prototype, "getOne", null);
__decorate([
    (0, common_1.Post)(),
    ...
    __metadata("design:returntype", void 0)
], LighterVesselsController.prototype, "create", null);
__decorate([
    (0, common_1.Patch)(":id"),
    (0, roles_decorator_1.Roles)(...master_data_roles_1.MASTER_DATA_EDITOR_ROLES),
    __param(0, (0, common_1.Param)("id")),
    ...
    __metadata("design:returntype", void 0)
], LighterVesselsController.prototype, "patch", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], LighterVesselsController.prototype, "remove", null);
exports.LighterVesselsController = LighterVesselsController = __decorate([
    (0, common_1.Controller)("master-data/lighter-vessels"),
...
//# sourceMappingURL=lighter-vessels.controller.js.map